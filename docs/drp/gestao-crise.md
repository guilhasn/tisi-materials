...
1. [O que e a gestão de crise](#1-o-que-e-a-gestao-de-crise)
...
## 1. O que é a gestão de crise

A **gestão de crise** (crisis management) engloba as ações tomadas **durante e após um desastre**, com foco nas **pessoas envolvidas** e na **viabilidade do negócio**. Enquanto a equipa técnica recupera sistemas, a equipa de gestão de crise gere a organização como um todo.

> A gestão de crise não é um problema técnico. E um problema organizacional que precisa de lideranca, comunicação e decisão sob pressão.
...
A gestão de crise distingue-se da recuperação técnica em vários aspetos:

| Aspeto | Recuperação técnica (DRP) | Gestão de crise |
|--------|--------------------------|-----------------|
...
## 3. Comunicação durante o desastre

A comunicação e talvez o aspeto mais crítico e mais frequentemente falhado da gestão de crise. Uma comunicação fraca pode amplificar os danos de um desastre.

### Principios de comunicação em crise

| Principio | Descrição | Exemplo de falha |
|-----------|-----------|-----------------|
| **Rapidez** | Comunicar o mais cedo possível, mesmo que a informação seja incompleta | Silencio durante 48 horas gera rumores e pânico |
...
```
  ╔═══════════════════════════════════════════════════════════════╗
  ║           MATRIZ DE COMUNICACAO EM CRISE                      ║
  ╠═══════════════════════════════════════════════════════════════╣
  ║                                                               ║
  ║  ┌──────────────┐  Prioridade 1: Colaboradores               ║
  ║  │ INTERNOS     │  "O que aconteceu, como vos afeta,          ║
  ║  │              │   o que estamos a fazer"                    ║
  ║  └──────────────┘                                             ║
  ║                                                               ║
  ║  ┌──────────────┐  Prioridade 2: Clientes e parceiros        ║
  ║  │ CLIENTES     │  "Impacto nos vossos serviços,              ║
  ║  │              │   prazo de resolução, alternativas"         ║
  ║  └──────────────┘                                             ║
  ║                                                               ║
  ║  ┌──────────────┐  Prioridade 3: Reguladores                 ║
  ║  │ REGULADORES  │  "Notificação formal, conformidade,         ║
  ║  │              │   medidas tomadas"                          ║
  ║  └──────────────┘                                             ║
  ║                                                               ║
  ║  ┌──────────────┐  Prioridade 4: Media e público             ║
  ║  │ PUBLICO      │  "Comunicado oficial, factos confirmados,   ║
  ║  │              │   ação em curso"                            ║
  ║  └──────────────┘                                             ║
  ╚═══════════════════════════════════════════════════════════════╝
```
...
Durante um desastre, os canais normais de comunicação podem estar indisponíveis. O plano deve prever **alternativas**:

| Canal normal | Alternativa | Quando usar |
|-------------|-------------|-------------|
...
```
  ┌───────────────────────────────────────────────────────┐
  │            PROCESSO DE DECLARACAO DE DESASTRE          │
  │                                                        │
  │  ┌──────────────┐                                     │
  │  │ Evento       │                                     │
  │  │ detetado     │                                     │
  ...
  │         ▼                                              │
  │  ┌──────────────┐                                     │
  │  │ DECLARACAO   │───► Ativar DRP                      │
  │  │ FORMAL       │───► Ativar lista de alerta          │
  │  │              │───► Mobilizar recursos               │
  │  │              │───► Iniciar comunicação              │
  │  └──────────────┘                                     │
  └───────────────────────────────────────────────────────┘
...
1. A gestão de crise e responsabilidade exclusiva da equipa de TI.
...
**Exercício 2.1 — Plano de comunicação**
...
**Exercício 2.2 — Quem decide?**

Para cada situação, indique **quem deve tomar a decisão** e justifique:

1. Declarar formalmente o desastre
2. Contactar a imprensa
3. Notificar a CNPD
4. Ativar o hotsite
5. Enviar colaboradores para casa

??? success "Solução 2.2"

    1. **CEO (ou delegado na cadeia de substituição)** — E a decisão de maior impacto organizacional e só pode ser tomada ao nível mais alto.
    2. **Responsável de comunicação, com aprovação do lider de crise** — A comunicação externa deve ser coordenada e aprovada, nunca improvisada.
    3. **DPO (Data Protection Officer), com apoio do jurídico** — A notificação a CNPD e uma obrigação legal (RGPD) e deve ser feita por quem conhece os requisitos legais.
    4. **Coordenador DRP, com aprovação do CISO/CTO** — E uma decisão técnica com implicações de custo significativas.
    5. **RH, com aprovação do lider de crise** — Envolve questões laborais, de segurança e de continuidade operacional.
...
??? success "Solução 3.1"
    ...
    **a) Equipa de gestão de crise:**
    ...
    - Jurídico (responsabilidade, seguros, conformidade)

    **b) Primeiras 5 ações (4 horas):**

    1. Confirmar com bombeiros que não há risco para pessoas e que a situação está controlada
    2. Avaliar danos ao armazém e ao stock de medicamentos (o que se perdeu, o que se pode salvar)
    3. Contactar seguradoras para iniciar processo de sinistro (documentar tudo com fotos/video)
    4. Avaliar impacto na cadeia de abastecimento — há medicamentos críticos sem stock alternativo?
    5. Preparar comunicação para clientes (farmacias, hospitais) sobre possíveis ruturas de fornecimento
...
### 1. "A gestão de crise começa quando o desastre acontece"

**Errado.** A gestão de crise **prepara-se antes** do desastre. Templates de comunicação, cadeia de decisão, contactos de emergência e procedimentos de evacuação devem estar definidos e testados antecipadamente.
...
### 3. "Qualquer pessoa pode falar com a imprensa"

**Perigoso.** Durante uma crise, a comunicação com média deve ser feita **exclusivamente** pelo porta-voz designado. Declaracoes contraditórias de diferentes colaboradores agravam a situação.

---

### 4. "O apoio ao pessoal pode esperar"

**Errado.** Os colaboradores são quem vai executar a recuperação. Se estão desinformados, stressados ou sem apoio, a recuperação será mais lenta e menos eficaz.

---

### 5. "A comunicação em crise e só para o exterior"

**Errado.** A comunicação **interna** e a primeira prioridade. Colaboradores desinformados são uma fonte de rumores, desinformação e pânico. Devem ser os primeiros a saber o que está a acontecer.
...
- *"A gestão de crise não é um problema técnico. E um problema de lideranca."*
- *"O silencio e a pior estratégia de comunicação em crise."*
